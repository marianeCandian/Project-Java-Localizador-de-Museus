...
public class MuseumController {
  ...
  /**
   * Metodo para buscar pelo Museum pelo id.
   */
  @GetMapping("/{id}")
  public MuseumDto getMuseumById(@PathVariable Long id) throws MuseumNotFoundException {
    Museum museum = museumServiceInterface.getMuseum(id);
    return ResponseEntity
        .status(HttpStatus.OK)
        .body((ModelDtoConverter.modelToDto(museum))).getBody();
  }
}
